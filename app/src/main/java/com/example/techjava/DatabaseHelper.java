...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_NAME = "tech.db";
    private static final int SCHEMA = 1; // версия базы данных
    static final String TABLE = "MALFUNCTIONS"; // название таблицы в бд
    // названия столбцов
    static final String COLUMN_ID = "_id";
    static final String COL_ADDRESS = "address";
    static final String COL_NUMBER = "number";
    static final String COL_I11 = "i11";
    static final String COL_I12 = "i12";
    static final String COL_I21 = "i21";
    static final String COL_I22 = "i22";
